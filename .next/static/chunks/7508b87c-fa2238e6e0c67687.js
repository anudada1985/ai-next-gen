"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[609],{4471:function(e,t,r){r.d(t,{PL:function(){return getDocs},ad:function(){return getFirestore},hJ:function(){return collection}});var n,i,s,a,o=r(3304),l=r(3576),u=r(8650),c=r(4534),h=r(3172),_=r(4203);r(2601);var d=r(263).Buffer;let m="@firebase/firestore",g="4.9.2";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let A="server_timestamp",R="__type__",y="__previous_value__",V="__local_write_time__";function __PRIVATE_isServerTimestamp(e){let t=(e?.mapValue?.fields||{})[R]?.stringValue;return t===A}function __PRIVATE_getPreviousValue(e){let t=e.mapValue.fields[y];return __PRIVATE_isServerTimestamp(t)?__PRIVATE_getPreviousValue(t):t}function __PRIVATE_getLocalWriteTime(e){let t=__PRIVATE_normalizeTimestamp(e.mapValue.fields[V].timestampValue);return new Timestamp(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let D=new SortedMap(DocumentKey.comparator),b=new SortedMap(DocumentKey.comparator);function documentMap(...e){let t=b;for(let r of e)t=t.insert(r.key,r);return t}function __PRIVATE_convertOverlayedDocumentMapToDocumentMap(e){let t=b;return e.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function __PRIVATE_newDocumentKeyMap(){return new ObjectMap(e=>e.toString(),(e,t)=>e.isEqual(t))}new SortedMap(DocumentKey.comparator);let N=new SortedSet(DocumentKey.comparator);function __PRIVATE_documentKeySet(...e){let t=N;for(let r of e)t=t.add(r);return t}let F=new SortedSet(__PRIVATE_primitiveComparator);function __PRIVATE_targetIdSet(){return F}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let RemoteEvent=class RemoteEvent{constructor(e,t,r,n,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=n,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){let n=new Map;return n.set(e,TargetChange.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new RemoteEvent(SnapshotVersion.min(),n,new SortedMap(__PRIVATE_primitiveComparator),D,__PRIVATE_documentKeySet())}};let TargetChange=class TargetChange{constructor(e,t,r,n,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=n,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new TargetChange(r,t,__PRIVATE_documentKeySet(),__PRIVATE_documentKeySet(),__PRIVATE_documentKeySet())}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let z="RestConnection",Q={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};let __PRIVATE_RestConnection=class __PRIVATE_RestConnection{get $o(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;let t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),n=encodeURIComponent(this.databaseId.database);this.Uo=t+"://"+e.host,this.Ko=`projects/${r}/databases/${n}`,this.Wo=this.databaseId.database===v?`project_id=${r}`:`project_id=${r}&database_id=${n}`}Go(e,t,r,n,i){let s=__PRIVATE_generateUniqueDebugId(),a=this.zo(e,t.toUriEncodedString());__PRIVATE_logDebug(z,`Sending RPC '${e}' ${s}:`,a,r);let o={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Wo};this.jo(o,n,i);let{host:l}=new URL(a),u=(0,c.Xx)(l);return this.Jo(e,a,o,r,u).then(t=>(__PRIVATE_logDebug(z,`Received RPC '${e}' ${s}: `,t),t),t=>{throw __PRIVATE_logWarn(z,`RPC '${e}' ${s} failed with error: `,t,"url: ",a,"request:",r),t})}Ho(e,t,r,n,i,s){return this.Go(e,t,r,n,i)}jo(e,t,r){e["X-Goog-Api-Client"]="gl-js/ fire/"+p,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,r)=>e[r]=t),r&&r.headers.forEach((t,r)=>e[r]=t)}zo(e,t){let r=Q[e];return`${this.Uo}/v1/${t}:${r}`}terminate(){}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $="WebChannelConnection";let __PRIVATE_WebChannelConnection=class __PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,r,n,i){let s=__PRIVATE_generateUniqueDebugId();return new Promise((i,a)=>{let o=new _.JJ;o.setWithCredentials(!0),o.listenOnce(_.tw.COMPLETE,()=>{try{switch(o.getLastErrorCode()){case _.jK.NO_ERROR:let t=o.getResponseJson();__PRIVATE_logDebug($,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(t)),i(t);break;case _.jK.TIMEOUT:__PRIVATE_logDebug($,`RPC '${e}' ${s} timed out`),a(new FirestoreError(E.DEADLINE_EXCEEDED,"Request time out"));break;case _.jK.HTTP_ERROR:let r=o.getStatus();if(__PRIVATE_logDebug($,`RPC '${e}' ${s} failed with status:`,r,"response text:",o.getResponseText()),r>0){let e=o.getResponseJson();Array.isArray(e)&&(e=e[0]);let t=e?.error;if(t&&t.status&&t.message){let e=function(e){let t=e.toLowerCase().replace(/_/g,"-");return Object.values(E).indexOf(t)>=0?t:E.UNKNOWN}(t.status);a(new FirestoreError(e,t.message))}else a(new FirestoreError(E.UNKNOWN,"Server responded with status "+o.getStatus()))}else a(new FirestoreError(E.UNAVAILABLE,"Connection failed."));break;default:fail(9055,{l_:e,streamId:s,h_:o.getLastErrorCode(),P_:o.getLastError()})}}finally{__PRIVATE_logDebug($,`RPC '${e}' ${s} completed.`)}});let l=JSON.stringify(n);__PRIVATE_logDebug($,`RPC '${e}' ${s} sending request:`,n),o.send(t,"POST",l,r,15)})}T_(e,t,r){let i=__PRIVATE_generateUniqueDebugId(),s=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=(0,_.UE)(),o=(0,_.FJ)(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;void 0!==u&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.jo(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;let c=s.join("");__PRIVATE_logDebug($,`Creating RPC '${e}' stream ${i}: ${c}`,l);let h=a.createWebChannel(c,l);this.I_(h);let d=!1,m=!1,g=new __PRIVATE_StreamBridge({Yo:t=>{m?__PRIVATE_logDebug($,`Not sending because RPC '${e}' stream ${i} is closed:`,t):(d||(__PRIVATE_logDebug($,`Opening RPC '${e}' stream ${i} transport.`),h.open(),d=!0),__PRIVATE_logDebug($,`RPC '${e}' stream ${i} sending:`,t),h.send(t))},Zo:()=>h.close()}),__PRIVATE_unguardedEventListen=(e,t,r)=>{e.listen(t,e=>{try{r(e)}catch(e){setTimeout(()=>{throw e},0)}})};return __PRIVATE_unguardedEventListen(h,_.ii.EventType.OPEN,()=>{m||(__PRIVATE_logDebug($,`RPC '${e}' stream ${i} transport opened.`),g.o_())}),__PRIVATE_unguardedEventListen(h,_.ii.EventType.CLOSE,()=>{m||(m=!0,__PRIVATE_logDebug($,`RPC '${e}' stream ${i} transport closed`),g.a_(),this.E_(h))}),__PRIVATE_unguardedEventListen(h,_.ii.EventType.ERROR,t=>{m||(m=!0,__PRIVATE_logWarn($,`RPC '${e}' stream ${i} transport errored. Name:`,t.name,"Message:",t.message),g.a_(new FirestoreError(E.UNAVAILABLE,"The operation could not be completed")))}),__PRIVATE_unguardedEventListen(h,_.ii.EventType.MESSAGE,t=>{if(!m){let r=t.data[0];__PRIVATE_hardAssert(!!r,16349);let s=r?.error||r[0]?.error;if(s){__PRIVATE_logDebug($,`RPC '${e}' stream ${i} received error:`,s);let t=s.status,r=function(e){let t=n[e];if(void 0!==t)return __PRIVATE_mapCodeFromRpcCode(t)}(t),a=s.message;void 0===r&&(r=E.INTERNAL,a="Unknown error status: "+t+" with message "+s.message),m=!0,g.a_(new FirestoreError(r,a)),h.close()}else __PRIVATE_logDebug($,`RPC '${e}' stream ${i} received:`,r),g.u_(r)}}),__PRIVATE_unguardedEventListen(o,_.ju.STAT_EVENT,t=>{t.stat===_.kN.PROXY?__PRIVATE_logDebug($,`RPC '${e}' stream ${i} detected buffering proxy`):t.stat===_.kN.NOPROXY&&__PRIVATE_logDebug($,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{g.__()},0),g}terminate(){this.c_.forEach(e=>e.close()),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter(t=>t===e)}};function getDocument(){return"undefined"!=typeof document?document:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
